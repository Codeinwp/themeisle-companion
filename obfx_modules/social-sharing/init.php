...
class Social_Sharing_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	public function __construct() {
		 ...
		 */
		$this->description = sprintf( __( 'Add basic social sharing to your posts and pages. Check out the %s to learn more!', 'themeisle-companion' ), sprintf( '<a href="https://docs.themeisle.com/article/1270-social-sharing-icons-orbit-fox-module/" rel="nofollow" target="_blank">%s</a>', __( 'demo', 'themeisle-companion' ) ) );
	}

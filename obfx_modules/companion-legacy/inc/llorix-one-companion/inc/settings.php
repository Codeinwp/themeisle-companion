...
function llorix_one_companion_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'Llorix_One_Lite_General_Repeater' ) ) {
		...
		$wp_customize->add_section(
			'llorix_one_lite_services_section',
			array(
		...
		$wp_customize->add_setting(
			'llorix_one_lite_services_content',
			array(
		...
		/* Team Background	*/
		$wp_customize->add_setting(
			'llorix_one_lite_our_team_background',
			array(
		...
		$wp_customize->add_section(
			'llorix_one_lite_testimonials_section',
			array(
		...
		$wp_customize->add_setting(
			'llorix_one_lite_testimonials_content',
			array(
				'sanitize_callback' => 'llorix_one_lite_sanitize_repeater',
				'default'           => $default,
			)

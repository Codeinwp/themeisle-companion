					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center">
							...
							if ( ! empty( $hestia_team_title ) || is_customize_preview() ) {
								echo '<h2 class="hestia-title">' . themeisle_hestia_sanitize_string( $hestia_team_title ) . '</h2>';
							}
							if ( ! empty( $hestia_team_subtitle ) || is_customize_preview() ) {
								echo '<h5 class="description">' . themeisle_hestia_sanitize_string( $hestia_team_subtitle ) . '</h5>';
							}
							?>
						</div>
					</div>

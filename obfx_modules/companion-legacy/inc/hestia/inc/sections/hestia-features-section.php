					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							...
							if ( ! empty( $hestia_features_title ) || is_customize_preview() ) {
								echo '<h2 class="hestia-title">' . hestia_sanitize_string( $hestia_features_title ) . '</h2>';
							}
							if ( ! empty( $hestia_features_subtitle ) || is_customize_preview() ) {
								echo '<h5 class="description">' . hestia_sanitize_string( $hestia_features_subtitle ) . '</h5>';
							}
							?>
						</div>
					</div>

...
class Theme_Update_Check_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	public function options() {
		return array(
			...
			array(
				...
				'type'    => 'toggle',
				'label'   => 'Toggle to activate automatic checks.',
				'default' => '0',
			),
		);
	}
	...
	public function hooks() {
		if ( (bool) $this->get_option( 'auto_update_checks' ) ) {
		...
		if( $info !== false ) {
			...
			if ( isset( $info['changes'] ) ) {
				...
				if ( $changes['status_code'] === '200' ) {
					$changes_info = sprintf(
						'<p><strong>' .
								__( 'There is a difference of %1$s%% when updating to version %2$s from %3$s. 
									<a href="%4$s" target="_blank">View changes details</a>.' ) .
								'</strong> -- auto generated by OrbitFox</p>',

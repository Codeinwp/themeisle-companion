			...
			if ( ! empty( $checks ) ) {
				if( isset( $checks[$payload_sha] ) && ! empty( $checks[$payload_sha] ) ) {
					...
					$changes_info = sprintf(
						'<small>' . __( 'There is a difference of %1$s%% when updating to version %2$s from %3$s. <a href="%4$s" target="_blank">View changes details</a>.' ) . ' -- auto generated by OrbitFox</small>',

...
<div id="obfx-wrapper">
	...
	<div class="panel">
		<div class="panel-header text-center">
			...
			<div class="panel-title mt-10"><?php echo __( 'Orbit Fox Modules', 'obfx' ); ?></div>
		</div>
		<div class="panel-nav">
			<ul class="tab tab-block">
				<li class="tab-item active">
					<a href="#" class="badge" data-badge="<?php echo $count_modules; ?>" data-initial="0"><?php echo __( 'Modules List', 'obfx' ); ?></a>
				</li>
				<li class="tab-item">
					<a href="#"><?php echo __( 'Settings', 'obfx' ); ?></a>
				</li>
			</ul>
		</div>
